...
# Load the CSV
df = pd.read_csv('C:/Users/Sakshi/Downloads/delhi_crime_data.csv')
...
# Save to new CSV
df.to_csv('C:/Users/Sakshi/Downloads/delhi_crime_data_modified.csv', index=False)
print("✅ Cleaned Delhi data saved.")
